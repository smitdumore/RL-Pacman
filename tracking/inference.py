...
def constructBayesNet(gameState: hunters.GameState):
    ...
    # Domain of the possible x,y positions the ghost and pacman can take
    ...
    # Appending all positions inside the grid to pacman and ghost domain
    ...
    # Observations are distances of ghosts from pacman (not ghost positions)
    # Thus observations have domain of manhattan distance (x + y) + noise
...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance: int, pacmanPosition: Tuple, ghostPosition: Tuple, jailPosition: Tuple):
        ...
        # We know ghost location with certainity when its in jail 
        # So return 1  
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation: int, gameState: busters.GameState):
        ...
        # grid_cell is a list of the possible ghost positions
        for grid_cell in self.allPositions:
            self.beliefs[grid_cell] *= self.getObservationProb(observation, pacmanpos, grid_cell, jailpos)
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState: busters.GameState):
        ...
        for j in range(self.numParticles):
            self.particles.append( legal_pos[ j % len(legal_pos) ] )
